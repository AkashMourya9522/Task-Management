...
export default function Task({ data, onClick }) {
  return (
    <div
      onClick={onClick}
      className="bg-white rounded-lg p-3 w-[300px] h-60  flex flex-col gap-3 hover:translate-y-2 hover:shadow-lg hover:cursor-pointer hover:bg-green-100 transition-all duration-300"
    >
